...
AccelerometerTrusted_node1758675362256 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://jtay553-lake-house/accelerometer/trusted/"], "recurse": True}, transformation_ctx="AccelerometerTrusted_node1758675362256")

# Script generated for node Join
Join_node1758676273670 = Join.apply(frame1=AccelerometerTrusted_node1758675362256, frame2=CustomerTrusted_node1758675409539, keys1=["user"], keys2=["email"], transformation_ctx="Join_node1758676273670")
...
'''
DropFieldsandDuplicates_node1758753882434 = sparkSqlQuery(glueContext, query = SqlQuery163, mapping = {"myDataSource":Join_node1758676273670}, transformation_ctx = "DropFieldsandDuplicates_node1758753882434")
